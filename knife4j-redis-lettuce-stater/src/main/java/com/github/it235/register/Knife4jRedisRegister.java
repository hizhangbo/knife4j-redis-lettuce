...
//            }
            ...
            redisTemplate.getPropertyValues().add("valueSerializer", stringRedisSerializer);
            redisTemplate.getPropertyValues().add("hashValueSerializer", stringRedisSerializer);
